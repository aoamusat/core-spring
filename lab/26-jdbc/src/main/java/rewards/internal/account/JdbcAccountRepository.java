...
public class JdbcAccountRepository implements AccountRepository {
	...
	private ResultSetExtractor<Account> accountExtractor = new AccountResultSetExtractor();
	...
	public Account findByCreditCard(String creditCardNumber) {
		...
		account = jdbcTemplate.query(sql, accountExtractor, creditCardNumber);
		return account;
	}
	...
	private class AccountRowMapper implements RowMapper<Account> {
		public Account mapRow(@NonNull ResultSet rs, int rowNum) throws SQLException {
			Account account = new Account(rs.getString("ACCOUNT_NUMBER"), rs.getString("ACCOUNT_NAME"));
			account.setEntityId(rs.getLong("ID"));
			account.restoreBeneficiary(mapBeneficiary(rs));
			return account;
		}
	...
	@SuppressWarnings("unused")
	private class AccountResultSetExtractor implements ResultSetExtractor<Account> {
		public Account extractData(@NonNull ResultSet rs) throws SQLException {
